...
class Ruleta{
    private:
        ...
        lanzamientos_;  /**< Almacena el numero de veces que se giro la ruleta*/
    ...
    public:
         ...
         * Comprueba si pudo abrirse correctamente, en caso afirmativ escribe los datos de todos
         ...
         * 
         * En caso de que no se pueda crear correctamente el archivo lo notificará por consola y retornara false.
         */
        bool escribeJugadores();
         ...
         * DNI,código,nombre,apellidos,dirección,localidad,provincia,país,dinero
         * 
         * Guarda los datos de cada jugador en la lista jugadores_ y retorna true.
         * 
         ...
         * @var <int> val <- Se utiliza para almacenar el valor de la apuesta de manera numerica
         * 
         ...
         * @return <bool> true || false
        */
        inline bool apuesta1(int *valor)const {return getBola()==(*valor)?true:false;}
         ...
         * @return <bool> true || false
         */
        inline bool esPar(int *valor){return (*valor)%2==0?true:false;}
         ...
         * @return <bool> true || false
         */
        inline bool esAlto(int *valor)const {return (*valor)>18?true:false;}



        void getEstadoRuleta(int *nJugadores, int *totalDinero, int *lanzamientos, int *balanceBanca);
